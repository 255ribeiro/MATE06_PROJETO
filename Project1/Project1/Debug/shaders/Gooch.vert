...
void main(void) { 
	...
	// Convertendo posição e normal para coordenadas homogeneas
...
// vetores de saida
	...
	// vetor partindo do vértice em direção aa fonte de luz
	vecL = uLPos2 - aPosition.xyz;
	// vetor partindo do vértice em direção aa camera
